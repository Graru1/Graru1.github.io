...
function m_bounce() {
	...
	if (document.getElementById("chk_bouncesCheck").checked && !wrongInputFloor || document.getElementById("chk_bouncesCheck").checked && !wrongInputCeiling) {
		...
		if (bounceResult[0] == 0 && !wrongInputFloor) {
			...
			if (bounceResult[1] == 1) {
				walkOutU = "<tr><td class='text-right' style='color:green'>Walk</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Uncrouched</td></tr>"
			} else if (bounceResult[1] == 2) {
				walkOutU = "<tr><td class='text-right' style='color:#28bbbb'>Walk</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Uncrouched (doublebouncehop)</td></tr>"
			};
			if (bounceResult[2] == 1) {
				walkOutC = "<tr><td class='text-right' style='color:green'>Walk</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Crouched</td></tr>"
			};
			if (bounceResult[3] == 1) {
				jumpOutU = "<tr><td class='text-right' style='color:green'>Jump</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Uncrouched</td></tr>"
			} else if (bounceResult[3] == 2) {
				jumpOutU = "<tr><td class='text-right' style='color:#28bbbb'>Jump</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Uncrouched (doublebouncehop)</td></tr>"
			};
			if (bounceResult[4] == 1) {
				jumpOutC = "<tr><td class='text-right' style='color:green'>Jump</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Crouched</td></tr>"
			};
			if (bounceResult[5] == 1) {
				ctapOutU = "<tr><td class='text-right' style='color:green'>Ctap</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Uncrouched</td></tr>"
			} else if (bounceResult[5] == 2) {
				ctapOutU = "<tr><td class='text-right' style='color:#28bbbb'>Ctap</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Uncrouched (doublebouncehop)</td></tr>"
			};
			if (bounceResult[6] == 1) {
				ctapOutC = "<tr><td class='text-right' style='color:green'>Ctap</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Crouched</td></tr>"
			};
			if (bounceResult[7] == 1) {
				cjumpOutU = "<tr><td class='text-right' style='color:green'>Crouch Jump</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Uncrouched</td></tr>"
			} else if (bounceResult[7] == 2) {
				cjumpOutU = "<tr><td class='text-right' style='color:#28bbbb'>Crouch Jump</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Uncrouched (doublebouncehop)</td></tr>"
			};
			if (bounceResult[8] == 1) {
				cjumpOutC = "<tr><td class='text-right' style='color:green'>Crouch Jump</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Crouched</td></tr>"
			};
			if (bounceResult[9] == 1) {
				cwalkOutU = "<tr><td class='text-right' style='color:green'>Crouch Walk</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Uncrouched</td></tr>"
			} else if (bounceResult[9] == 2) {
				cwalkOutU = "<tr><td class='text-right' style='color:#28bbbb'>Crouch Walk</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Uncrouched (doublebouncehop)</td></tr>"
			};
			if (bounceResult[10] == 1) {
				cwalkOutC = "<tr><td class='text-right' style='color:green'>Crouch Walk</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Crouched</td></tr>"
			};
		...
		if (bounceFound == 0 && ceilingResult[0] == 0 && !wrongInputCeiling) {
			...
			document.getElementById("bounceResultsU").style.display = "";
			document.getElementById("bounceResultsC").style.display = "";
			if (ceilingResult[1] == 1) {
				ceilingOutU = "<tr><td class='text-right' style='color:green'>Ceilingsmash</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Uncrouched</td></tr>"
			} else if (ceilingResult[1] == 2) {
				ceilingOutU = "<tr><td class='text-right' style='color:#28bbbb'>Ceilingsmash</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Uncrouched (doublebouncehop)</td></tr>"
			};
			if (ceilingResult[2] == 1) {
				ceilingOutC = "<tr><td class='text-right' style='color:green'>Ceilingsmash</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Crouched</td></tr>"
			};
...
function m_jumpbug() {
	...
	if (document.getElementById("chk_bouncesCheck").checked && !wrongInputFloor || document.getElementById("chk_bouncesCheck").checked && !wrongInputCeiling) {
		...
		if (bounceResult[0] == 0 && !wrongInputFloor) {
			...
			document.getElementById("bounceResultsC").style.display = "";
			if (bounceResult[1] == 1) {
				walkOutU = "<tr><td class='text-right' style='color:green'>Walk</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Jumpbug</td></tr>"
			} else if (bounceResult[1] == 2) {
				walkOutU = "<tr><td class='text-right' style='color:#28bbbb'>Walk</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Jumpbug (doublejumpbug)</td></tr>"
			};
			...
			if (bounceResult[3] == 1) {
				jumpOutU = "<tr><td class='text-right' style='color:green'>Jump</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Jumpbug</td></tr>"
			} else if (bounceResult[3] == 2) {
				jumpOutU = "<tr><td class='text-right' style='color:#28bbbb'>Jump</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Jumpbug (doublejumpbug)</td></tr>"
			};
			...
			if (bounceResult[5] == 1) {
				ctapOutU = "<tr><td class='text-right' style='color:green'>Ctap</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Jumpbug</td></tr>"
			} else if (bounceResult[5] == 2) {
				ctapOutU = "<tr><td class='text-right' style='color:#28bbbb'>Ctap</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Jumpbug (doublejumpbug)</td></tr>"
			};
			...
			if (bounceResult[7] == 1) {
				cjumpOutU = "<tr><td class='text-right' style='color:green'>Crouch Jump</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Jumpbug</td></tr>"
			} else if (bounceResult[7] == 2) {
				cjumpOutU = "<tr><td class='text-right' style='color:#28bbbb'>Crouch Jump</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Jumpbug (doublejumpbug)</td></tr>"
			};
			...
			if (bounceResult[9] == 1) {
				cwalkOutU = "<tr><td class='text-right' style='color:green'>Crouch Walk</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Jumpbug</td></tr>"
			} else if (bounceResult[9] == 2) {
				cwalkOutU = "<tr><td class='text-right' style='color:#28bbbb'>Crouch Walk</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Jumpbug (doublejumpbug)</td></tr>"
			};
		...
		if (bounceFound == 0 && ceilingResult[0] == 0 && !wrongInputCeiling) {
			...
			document.getElementById("bounceResultsC").style.display = "";
			if (ceilingResult[1] == 1) {
				ceilingOutU = "<tr><td class='text-right' style='color:green'>Ceilingsmash</td><td style='width: 46px; color:green'> -&gt; </td><td class='text-left' style='color:green'>Jumpbug</td></tr>"
			} else if (ceilingResult[1] == 2) {
				ceilingOutU = "<tr><td class='text-right' style='color:#28bbbb'>Ceilingsmash</td><td style='width: 46px; color:#28bbbb'> -&gt; </td><td class='text-left' style='color:#28bbbb'>Jumpbug (doublejumpbug)</td></tr>"
			};
